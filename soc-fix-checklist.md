...
- [ ] **8. Fix the UTC clock mislabel.** Multi-screen status bar shows local time labeled "UTC" — use `getUTCHours()` or relabel.
- [ ] **9. Print stylesheet.** `@media print` for the lesson and exercise editions: light background, accordions expanded, chrome hidden, page-break control.
